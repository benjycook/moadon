...
(function(){
var Configuration = SimpleAuthToken.Configuration;
/**
  ...
  @extends Base
*/
SimpleAuthToken.TokenAuthenticator = SimpleAuth.Authenticators.Base.extend({
  /**
  ...
  */
  init: function() {
    ...
    // {
    //   this.customFields[i]
    //   var key = this.customFields[i]+'Field';
    //   this[key] = '';
    // };
