...
<link href="merchantPages/WebSources/css/normalize.css" rel="stylesheet" type="text/css" /> 
<link href="merchantPages/WebSources/css/grid.css" rel="stylesheet" type="text/css" /> 
<link href="merchantPages/WebSources/css/responsive.main.rtl.css" rel="stylesheet" type="text/css" /> 
<%=responsiveEngCSS%>
...
<form id="creditForm" onsubmit="return validateFormTrack2CardNo();" method="POST" action="ProcessCreditCard">
	...
	<div class="grid_12 row8">
			...
			<div class="grid_8 row8 td_style_fieldValue">
				<input type="text" id="Track2CardNo" name="Track2CardNo" maxlength="40" width="100%" dir="ltr" autocomplete="off" onchange="return validateTrack2CardNo();" disabled />
			</div>
	...
	<div class="grid_12 row9">
			...
			<div class="grid_8 row9 td_style_fieldValue">
				<select id="expYear" name="expYear" onchange="validateExpDate();" disabled >
					<%=expYear%>
				</select>
				-
				<select id="expMonth" name="expMonth" onchange="validateExpDate();" disabled >
					<option value=""></option>
	...
	<div class="grid_12 row10">		
			...
			<div class="grid_8 row10 td_style_fieldValue">
				<input type="text" name="cvv" id="cvv" maxlength="4" style="width: 50px;" dir="ltr" autocomplete="off" onchange="return validateCvv()" disabled />
				<img id="qm" src="merchantPages/WebSources/images/qm.png"  onmouseover="showHideCVVhelp();" onmouseout="showHideCVVhelp();" style="cursor:pointer;"/>
	...
	<div class="grid_12 row12">
			...
			<div class="grid_8 row12 td_style_fieldValue">
				<input type="text" id="personalId" name="personalId" maxlength="9" dir="ltr" autocomplete="off" onchange="return validatePersonalId()" disabled />
			</div>
	...
	<%=getResponsivePaymentsHTML()%>
		...
		<div id="form_buttons" class="grid_12 row13 td_style_fieldValue">
			...
			<input id="resetBtn" type="reset" value="<%=formReset%>" disabled /> 
			<%=getCancelBtnHTML("")%>
		</div>
...
<div class="grid_12 row14" height="100%" style="max-height: 3em;">		
	<img class="row14 pci_image" width="12.1%" src="merchantPages/WebSources/images/pci_slice.gif" alt="pci logo" title="pci logo"/>
	<img class="row14 pci_image" width="16%" src="merchantPages/WebSources/images/mastercard_slice.gif" alt="mastercard" title="mastercard"/>
	<img class="row14 pci_image" width="16%" src="merchantPages/WebSources/images/visa_slice.gif" alt="visa" title="visa"/>
	<div class="responsive_page_line_break"></div>
